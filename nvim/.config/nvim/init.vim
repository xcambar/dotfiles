...
if !exists('vimpager')
  ...
  autocmd VimEnter * source $HOME/.config/nvim/config/editor.vim
else
  autocmd VimEnter * source $HOME/.config/nvim/config/pager.vim
endif
call plug#end()

source $HOME/.config/nvim/config/themes/base16.vim
source $HOME/.config/nvim/config/plugins/vim-emoji.vim
